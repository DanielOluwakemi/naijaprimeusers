...
public class ViewerController {
    ...
    public ResponseEntity<?> update(@RequestBody Viewer creator){
        log.info("API Call To Edit Viewer");

        try {
            ResponseDTO response = viewerService.update(creator);
            if(response.getStatus().equalsIgnoreCase("SUCCESS")) {
    ...
    @Operation(description = "This Service gets all users on naijaprimeusers")
